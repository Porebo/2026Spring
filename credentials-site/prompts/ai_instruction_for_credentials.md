...
This repository is the canonical home for portfolio and credential content. The [2026Spring](https://github.com/Porebo/2026Spring) repo links here for bio and education details.
...
2. Keep semantic attributes: `role="list"`, `role="listitem"`, meaningful `alt` text.
