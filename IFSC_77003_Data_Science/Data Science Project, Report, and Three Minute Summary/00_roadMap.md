...
**Feeds from:** `05_dataSelectionResearchDesignAndMethods.md`, `03_introduction.md`.
**Still needed:**
...
**Feeds from:** `05_dataSelectionResearchDesignAndMethods.md` (contains the `New_InjCentered_Daily2_3957.twbx` example).
**Still needed:**
...
**Feeds from:** the ten lit-note files (citations), `05_dataSelectionResearchDesignAndMethods.md` (discovery example).
...
**Feeds from:** `03_introduction.md` (narrative), `05_dataSelectionResearchDesignAndMethods.md` (finding).
...
| 5 Methods | Partial | Yes (`05_dataSelectionResearchDesignAndMethods.md`, `03_introduction.md`) | No |
